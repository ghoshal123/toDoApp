...
const TodoList = ({ element, notes, setTitle,  setNotes,  title }) => {
  ...
  return (
    <div>
    <div className="card-header" style={{ color: "black" }}><h3>Todos:{element.todo}</h3></div>
            <div className="card-body text-secondary">
                ...
                <button type="button" className="btn btn-Light mx-2" onClick={() => { completeData(element.id) }}><i class="icon-check" style={{fontSize:"40px",color:"green"}}></i></button>
            </div>
